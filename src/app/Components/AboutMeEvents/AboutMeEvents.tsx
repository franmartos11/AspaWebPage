          ...
          <section className="mb-32 text-center">
            <div className="flex justify-center items-center">
              <div className="grid gap-6 lg:grid-cols-3 xl:gap-x-12 ">
                <AboutMeCard
                  type={texts[language].card1.type}
                  title={texts[language].card1.title}
                  text={texts[language].card1.text}
                  place={texts[language].card1.place}
                  link={texts[language].card1.link}
                  linkName={texts[language].card1.linkName}
                  img={texts[language].card1.img}
                ></AboutMeCard>
                <AboutMeCard
                  type={texts[language].card2.type}
                  title={texts[language].card2.title}
                  text={texts[language].card2.text}
                  place={texts[language].card2.place}
                  link={texts[language].card2.link}
                  linkName={texts[language].card2.linkName}
                  img={texts[language].card2.img}
                ></AboutMeCard>
                <AboutMeCard
                  type={texts[language].card3.type}
                  title={texts[language].card3.title}
                  text={texts[language].card3.text}
                  place={texts[language].card3.place}
                  link={texts[language].card3.link}
                  linkName={texts[language].card3.linkName}
