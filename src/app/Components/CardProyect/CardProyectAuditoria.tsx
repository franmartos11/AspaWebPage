...
export default function () {
  ...
  const texts = {
    es: {
      title: "Auditoria",
      subtitle:
        "¿Estás listo para llevar tu negocio al siguiente nivel? Nuestra App te permite realizar auditorías eficientes y completas.",
