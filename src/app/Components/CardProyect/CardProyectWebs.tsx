...
export default function CardProyectWeb() {
    ...
    const texts = {
        es: {
            ...
            desciption1: 'Un sitio web te permite estar presente en el mercado digital las 24 horas del día, los 7 días de la semana, para clientes de todo el mundo. No solo amplías tu alcance, sino que también abres nuevas oportunidades de negocio que antes no estaban disponibles. Aumenta tu visibilidad global y conecta con una audiencia internacional.',
            text2: 'Crecimiento del negocio',
            desciption2: 'Un sitio web atractivo y funcional es una herramienta poderosa para atraer nuevos clientes, aumentar tus ventas y fidelizar a los clientes existentes. A través de una experiencia online personalizada, ofreces una mejor atención al cliente y construyes relaciones duraderas. Impulsa el crecimiento de tu negocio con una presencia online efectiva.',
            text3: 'Imagen profesional',
            desciption3: 'Un sitio web moderno y profesional es la carta de presentación de tu negocio en el mundo digital. Te ayuda a proyectar una imagen de confianza, seriedad y competencia, lo que te da una ventaja sobre tus competidores. Destaca con una imagen profesional que refleje la calidad de tus servicios.',
        ...
        en: {
            ...
            desciption1: 'A website allows you to be present in the digital market 24/7 for customers around the world. Not only do you expand your reach, but you also open up new business opportunities that were previously unavailable. Increase your global visibility and connect with an international audience.',
            text2: 'Business Growth',
            desciption2: 'An attractive and functional website is a powerful tool to attract new customers, increase your sales, and retain existing clients. Through a personalized online experience, you offer better customer service and build lasting relationships. Drive your business growth with an effective online presence.',
            text3: 'Professional Image',
            desciption3: 'A modern and professional website is your business is calling card in the digital world. It helps you project an image of trust, seriousness, and competence, giving you an edge over your competitors. Stand out with a professional image that reflects the quality of your services.',
            text4: 'Efficiency and Automation',
            desciption4: 'A website allows you to optimize processes, automate repetitive tasks, and eliminate the need for personnel for certain activities. This saves you time and money, allowing you to focus on what really matters: growing your business. Improve efficiency and automate processes to maximize your resources.',
            text5: 'Digital Marketing',
            desciption5: 'A website is the fundamental base for implementing effective online marketing strategies. It allows you to reach your target audience precisely, increase traffic to your website, generate leads and conversions, and ultimately boost your sales. Enhance your digital marketing and achieve your business goals.'
        },
                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="max-w-xl text-base leading-7 text-gray-200 lg:max-w-lg">
                            ...
                            <br />
                            <p>
                                {texts[language].desciption1}<br />
                                <br />
                            </p>
                            <h2 className="text-xl">{texts[language].text2}</h2>

                            <p className="mt-6">
                                {texts[language].desciption2}<br />
                                <br />
                            </p>
