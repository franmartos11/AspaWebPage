                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="max-w-xl text-base leading-7 text-gray-200 lg:max-w-lg">
                            <br />
                            <h2 className="text-xl">Visibilidad global:</h2>
                            <br />
                            <p>
                            ...
                            <h2 className="text-xl">Crecimiento del negocio</h2>
                            ...
                            <h2 className="text-xl" >Imagen profesional</h2>
                            ...
                            <h2 className="text-xl">Eficiencia y automatización</h2>
                            ...
                            <h2 className="text-xl">Marketing digital</h2>
