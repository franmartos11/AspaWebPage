    ...
    return (
        <div className="container mx-auto px-4 pt-[15rem] py-[6rem]">
            ...
            <div className="flex flex-wrap justify-evenly items-center">
                <CardHome title={texts[language].card1.title} paragraph={texts[language].card1.paragraph} img={texts[language].card1.img} ></CardHome>
                <CardHome title={texts[language].card3.title} paragraph={texts[language].card3.paragraph} img={texts[language].card3.img}></CardHome>
                <CardHome title={texts[language].card2.title} paragraph={texts[language].card2.paragraph} img={texts[language].card2.img}></CardHome>
            </div>
        </div>
    );
}
