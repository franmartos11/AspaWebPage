...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[180vh]  flex flex-col items-center py-0 md:pb-[15rem] md:pt-[8rem] justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
