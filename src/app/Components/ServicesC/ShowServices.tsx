export default function(){
    return(
        <section className="mx-auto pt-[15rem] pb-[4rem] flex max-w-lg flex-col px-4 py-10 lg:max-w-screen-xl lg:flex-row">
  ...
  <div className="">
    ...
    <h2 className="mb-10 max-w-lg text-4xl font-bold leading-snug lg:text-5xl lg:leading-snug">Una forma<span className="text-blue-500"> revolucionaria</span> de digitalizar tu negocio</h2>
