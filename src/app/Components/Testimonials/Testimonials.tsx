      ...
      <section className="max-w-5xl mx-auto w-full px-10 py-10">
        <div className="flex items-center justify-center flex-col gap-y-2 py-5">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold max-w-md mx-auto text-center text-white">
            Lo que nuestros
            <span className="text-[#3b82f6]"> clientes</span> dicen sobre
            nosotros
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 w-full">
          <div className="border p-7 rounded-xl bg-neutral-950 drop-shadow-md border-neutral-800/50 col-span-2 flex flex-col gap-y-10 justify-between">
            <div className="flex flex-col gap-y-3.5">
              ...
              <p className="font-medium text-white">
                ASPA se ha podido alinear con los objetivos de mi proyecto,
                incluso estando en continentes diferente
              </p>
            </div>
          ...
          <div className="border p-7 rounded-xl bg-neutral-950 drop-shadow-md border-neutral-800/50 col-span-3 flex flex-col gap-y-10 justify-between">
            <div className="flex flex-col gap-y-3.5">
              ...
              <p className="font-medium text-white">
                ASPA se ha podido alinear con los objetivos de mi proyecto,
                incluso estando en continentes diferente. Las reuniones y
                servicios entregados han sido a tiempo y del mejor nivel! Los
                recomiendo!
              </p>
            </div>
            <div className="flex flex-col">
          ...
          <div className="border p-7 rounded-xl bg-neutral-950 drop-shadow-md border-neutral-800/50 col-span-3 flex flex-col gap-y-10 justify-between">
            <div className="flex flex-col gap-y-3.5">
              <p className="font-bold text-xl text-white">Exelente servicio</p>
              <p className="font-medium text-white">
          ...
          <div className="border p-7 rounded-xl bg-neutral-950 drop-shadow-md border-neutral-800/50 col-span-2 flex flex-col gap-y-10 justify-between">
            <div className="flex flex-col gap-y-3.5">
              ...
              <p className="font-medium text-white">
                El trabajo de todo ASPA TEAM es eficiente, a tiempo, organizado
                y totalmente personalizado, recomiendo ampliamente.
              </p>
            </div>
            <div className="flex flex-col">
              <img
