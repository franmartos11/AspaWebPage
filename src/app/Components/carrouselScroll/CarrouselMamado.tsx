                ...
                <div className="grid grid-cols-1 gap-8 mt-0 xl:mt-1 md:grid-cols-2 xl:grid-cols-3">
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-sm dark:border-gray-700">
                        ...
                        <p className="mt-2   text-gray-300 text-center">
                            Desarrollamos la aplicación que necesites, con los
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-sm dark:border-gray-700">
                        ...
                        <p className="mt-2 text-gray-300 text-center">
                            Disponemos de aplicaciones desarrolladas para que
                            implementes en tu empresa.
                        </p>
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-sm dark:border-gray-700">
                        ...
                        <p className="mt-2 text-gray-300 text-center">
                            Desarrollamos webs para tu empresa, con los mejores
                            tiempos de entrega.
                        </p>
