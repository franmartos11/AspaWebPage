...
function ServiceCard({href,img,title,text}:{href : string, img: string, title: string, text: string}){
    return(
    ...
    const texts = {
        es:{
            ...
            card1:{
                ...
                description:'Disponemos de aplicaciones desarrolladas para que implementes en tu empresa',
                img:'/amedida.jpg'
            },
            card2:{
                title:'Aplicaciones Diseñadas',
            ...
            card3:{
                ...
                description:'Desarrollamos webs para tu empresa, con los mejores tiempos de entrega',
        ...
        en: {
            ...
            card1: {
                ...
                description: 'We have developed applications for you to implement in your company',
                img:'/amedida.jpg'
            },
            card2: {
                title: 'Designed Applications',
            ...
            card3: {
                ...
                description: 'We develop websites for your company, with the best delivery times',
                img:'/webdevelopment.webp'
            },
        },
    }
        ...
        <section className="pt-[0rem] pb-[10rem]">
            ...
            <div className="container px-6 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                <div className="grid grid-cols-1 gap-8 mt-0 xl:mt-1 md:grid-cols-2 xl:grid-cols-3">
                    <ServiceCard href={'#desarrollo-medida'} img={texts[language].card1.img} title={texts[language].card1.title} text={texts[language].card1.description}></ServiceCard>
                    <ServiceCard href={"#carcheck"} img={texts[language].card2.img} title={texts[language].card2.title} text={texts[language].card2.description}></ServiceCard>
                    <ServiceCard href={"#desarrollo-web"} img={texts[language].card2.img} title={texts[language].card3.title} text={texts[language].card1.description}></ServiceCard>
