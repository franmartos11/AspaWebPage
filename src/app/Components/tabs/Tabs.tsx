...
export const Tabs = ({
  ...
  return (
    <>
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn("absolute inset-0 bg-blue-500 rounded-full ", activeTabClassName)}
              />
            )}
      ...
      <FadeInDiv tabs={tabs} active={active} hovering={hovering} className={cn("mt-[8rem]", contentClassName)} />
    </>
  );
};
