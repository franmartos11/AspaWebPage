...
const steps = {
  es: [
    ...
    },
    {
      ...
      title: "Desarrollo",
      description:
        "Nuestro equipo de desarrolladores de apps construirá tu aplicación utilizando las tecnologías más adecuadas, ya sea en desarrollo de aplicaciones nativas o multiplataforma.",
    ...
    },
    {
      ...
      title: "Testing",
      description:
        "Todas las funcionalidades pasarán por un entorno de prueba en el que verificaremos que todo esté correcto.",
      icon: "/testing.png",
    },
    {
      id: 6,
      title: "Lanzamiento",
      description:
        "La publicación en las plataformas será cosa nuestra. Trabajaremos con Google y Apple para la aprobación y distribución de tu app en Google Play y App Store.",
  ...
  en: [
    ...
    },
    {
      ...
      description:
        "We will study, from a business perspective, which features can add the most value and how to position your app in the market.",
      icon: "/analisisM.png",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      title: "Development",
      description:
        "Our team of app developers will build your application using the most suitable technologies, whether for native or cross-platform development.",
      icon: "/desarrollo2.png",
    },
    {
      id: 5,
      title: "Testing",
      description:
        "All functionalities will go through a testing environment where we will verify that everything works correctly.",
      icon: "/testing.png",
    },
    {
      id: 6,
      title: "Launch",
      description:
        "We will take care of publishing your app. We work with Google and Apple for approval and distribution on Google Play and the App Store.",
      icon: "/lanzamiento.png",
    },
  ],
};
  ...
  return (
    <section className="py-[6rem] px-6 text-center">
      ...
      >
        ...
        <span className="text-blue-600 transition-all">
