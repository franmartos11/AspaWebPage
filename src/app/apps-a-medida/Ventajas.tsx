...
const Ventajas: React.FC = () => {
  ...
  const texts = {
    es: {
      ...
      subtext1:
        "Te ayudamos a definir qué tipo de app es ideal para tu negocio.",
    ...
    en: {
      ...
      paragraph2:
        "We not only design and build your application, but we also offer:",
      subtitle1: "Consulting",
      subtext1:
        "We help you define what type of app is ideal for your business.",
    ...
    >
      ...
      <div className="mt-[6rem] text-white grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="mt-4 text-xl font-semibold ">
            {texts[language].subtitle3}
          </h3>
          <p className="text-gray-400 text-sm mt-2">
            {texts[language].subtext3}{" "}
            <span className="font-bold">{texts[language].subtext31}</span>
          </p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="mt-4 text-xl font-semibold ">
            {texts[language].subtitle4}
          </h3>
          <p className="text-gray-400 text-sm mt-2">
            {texts[language].subtext4}
          </p>
        </div>
      </div>
    </motion.section>
