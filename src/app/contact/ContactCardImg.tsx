...
export default function ContactCardImg() {
  ...
  return (
    <section className="min-h-screen pt-[5rem] bg-black overflow-hidden">
      <div className="container px-6 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-10 relative">
            ...
            <form onSubmit={handleSubmit} className="mt-12 space-y-6">
              <div className="md:flex md:items-center md:-mx-2">
                <div className="flex-1 px-2">
                  ...
                  <input
                    name="name"
                    type="text"
                    className="block w-full px-5 py-3.5 mt-2 border border-white/10 rounded-xl placeholder-gray-500 bg-white/5 backdrop-blur-sm text-white transition-all duration-300 focus:border-blue-500 focus:ring-0 focus:shadow-[0_0_20px_rgba(59,130,246,0.3)] focus:bg-white/10 outline-none"
                    required
                  />
                </div>
                <div className="flex-1 px-2 mt-6 md:mt-0">
                  <label className="block mb-2 text-sm font-medium text-gray-300">
                    {texts.form.b}
                  </label>
                  <input
              ...
              <div className="w-full">
                ...
                <textarea
                  name="message"
                  rows={5}
                  className="block w-full px-5 py-3.5 mt-2 border border-white/10 rounded-xl placeholder-gray-500 bg-white/5 backdrop-blur-sm text-white transition-all duration-300 focus:border-blue-500 focus:ring-0 focus:shadow-[0_0_20px_rgba(59,130,246,0.3)] focus:bg-white/10 outline-none resize-none"
                  required
                />
              </div>
              ...
              <div className="text-center pt-4">
                <motion.button
                  type="submit"
                  disabled={loading}
                  className="w-full px-6 py-4 text-sm font-bold tracking-widest text-white uppercase transition-colors duration-300 transform rounded-xl bg-blue-600 disabled:opacity-50 shadow-lg shadow-blue-500/20"
          ...
          {/* Right Column - Info */}
          <motion.div 
            className="mt-12 pt-[3rem] lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10 relative"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            ...
            >
              <Image
                className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-80 h-80 shadow-2xl shadow-blue-900/20 border border-white/5"
                src="/aspaLogo.webp"
                alt="aspa logo"
                title="aspa logo"
                width={612}
            ...
            <div className="mt-8 space-y-8 md:mt-10 relative z-10 w-full max-w-sm">
              <motion.a
                title="Location"
                ...
                whileHover={{ y: -3 }}
              >
                <div className="p-3 bg-black rounded-full border border-white/10 group-hover:border-blue-500/50 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-400 group-hover:text-blue-300 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <span className="mx-4 truncate text-gray-300 group-hover:text-white transition-colors">
              ...
              >
                ...
                <span className="mx-4 truncate text-sm sm:text-base text-gray-300 group-hover:text-white transition-colors">
            ...
            <div className="mt-8 w-full max-w-sm flex flex-col items-center">
              <h3 className="text-gray-400 font-medium tracking-wide uppercase text-sm mb-4">{texts.form.e}</h3>
