  ...
  const projects = [
    {
      ...
      category: "E-Commerce / 3D Services",
      src: "/vpHome2.png",
      web: "https://www.visualpeephole.com",
    },
    {
      title: "DH Engineering Consulting LLC",
      category: "Corporate Consulting",
      src: "/dhengweb.png",
      web: "https://www.dhengconsulting.com/",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          {projects.map((project, index) => (
            ...
            >
              <Link href={project.web} target="_blank" className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden mb-6 block border border-white/5 bg-[#0a0a0a]">
